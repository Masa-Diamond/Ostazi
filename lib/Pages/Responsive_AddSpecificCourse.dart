...
class ResponsiveAddSpecificCourse extends StatelessWidget {
    final Widget DesktopBody;
    final Widget TabletBody;
    ResponsiveAddSpecificCourse({required this.DesktopBody,required this.TabletBody});
  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context,constraints){
        if(constraints.maxWidth < 1220){
          return AddSpecificCourseTablet();
        }else{return AddSpecificCourseDesktop();}
      },
    );
  }
}