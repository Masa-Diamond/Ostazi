...
class ChattScreen5 extends StatefulWidget {
  const ChattScreen5({super.key});

  @override
  State<ChattScreen5> createState() => _ChattScreen5State();
}

class _ChattScreen5State extends State<ChattScreen5> {
  @override
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  TextButton(
                    ...
                    _firestore.collection('messages5').add({
                      'text': messageText,
...
class MessageStreamBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: _firestore.collection('messages5').orderBy('time').snapshots(),
