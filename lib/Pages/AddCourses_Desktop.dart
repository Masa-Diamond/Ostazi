...
import 'package:grad_project/Pages/AddSpecificCourse-tablet.dart';
...
import 'package:grad_project/Pages/CoursesAdminAdd_class.dart';
import 'package:grad_project/Pages/Responsive_AddSpecificCourse.dart';
...
class AddCoursesDesktop extends StatefulWidget {
  const AddCoursesDesktop({super.key});

  @override
  State<AddCoursesDesktop> createState() => _AddCoursesDesktopState();
}

class _AddCoursesDesktopState extends State<AddCoursesDesktop> {
   // ignore: unused_field
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  setState(() {
                    print(id);
                    //var data = snapshot.data!.docs[id].data() as Map<String , dynamic>;
                    //FirebaseFirestore.instance.collection("courses").doc(data['uid']).delete();
