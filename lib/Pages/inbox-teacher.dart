...
import 'package:grad_project/Pages/chatting4.dart';
import 'package:grad_project/Pages/chatting5.dart';
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                          Text("ميرا صايمة",style: TextStyle(
                    ...
                    child: Column(
                      children: [
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                          Text("احمد محمد",style: TextStyle(
                            color: Color.fromARGB(255, 4, 4, 71),
                            fontWeight: FontWeight.bold,
                            fontSize: 20,
                          ),),
