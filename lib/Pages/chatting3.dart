...
class ChattScreen3 extends StatefulWidget {
  const ChattScreen3({super.key});

  @override
  State<ChattScreen3> createState() => _ChattScreen3State();
}

class _ChattScreen3State extends State<ChattScreen3> {
  @override
...
class MessageStreamBuilder extends StatelessWidget{
  ...
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('messages3').orderBy('time').snapshots(),
