...
class ResponsiveAddTeacher extends StatelessWidget {
    final Widget DesktopBody;
    final Widget TabletBody;
    ResponsiveAddTeacher({required this.DesktopBody,required this.TabletBody});
  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context,constraints){
        if(constraints.maxWidth < 1220){
          return AddTeacherTablet();
        }else{return AddTeacherDesktop();}
      },
    );
  }
}